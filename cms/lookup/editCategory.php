                                ...
                                <div class="card-body">
                                    ...
                                    <form id="formEvent" name="category" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-user" id="name" name="name" value="<?php echo $row_category['categoryName'];?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Description</label>
                                            <textarea class="form-control form-control-user" id="description" name="description"  required><?php echo $row_category['categoryDescription'];?></textarea>
                                        </div>
                                        <div class="form-group">
